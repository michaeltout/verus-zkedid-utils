...
describe('Payment request integration testing', function () {
  it('Can create and read a simple payment request, with a coin import.', function () {
    var coinObj = {
      id: 'TEST',
      name: 'TestCoin',
      isPbaasChain: true,
    ...
    expect(VerusZkedidUtils.VerusLink.readLink(VerusZkedidUtils.VerusLink.writeLink([VerusZkedidUtils.PresetObjects.VerusPaymentRequest.create(".vrsc", "800000000", 8, import_, "")]))).toBeDefined();
  });
});