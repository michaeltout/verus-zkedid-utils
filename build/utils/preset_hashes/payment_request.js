...
module.exports = {
  schemas: (_schemas = {}, _defineProperty(_schemas, VERUS_PAYMENT_REQUEST_HASH, [new UInt32("version"), new StructuredMemoString("type"), new StructuredPrototypeType(VERUS_PAYMENT_REQUEST_PAYLOAD)]), _defineProperty(_schemas, VERUS_PAYMENT_REQUEST_PAYLOAD_HASH, [new StructuredMemoString("currency_id"), new StructuredMemoString("amount"), new UInt32("decimals"), new StructuredMemoString("currency_import"), new StructuredMemoString("note")]), _schemas),
