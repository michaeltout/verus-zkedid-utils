...
module.exports = {
  schemas: (_schemas = {}, _defineProperty(_schemas, STRUCTURED_COIN_OBJECT_HASH, [new UInt32("coinObj_version"), new StructuredMemoString("id"), new StructuredMemoString("name"), new UInt32("coinObj_version"), new Boolean("isPbaasChain"), new StructuredMemoString("themeColor"), new StructuredPrototypeType("available_modes"), new StructuredPrototypeType("options")]), _defineProperty(_schemas, STRUCTURED_COIN_OBJECT_OPTIONS_HASH, [new UInt32("dustThreshold"), new UInt32("fallbackPort"), new StructuredMemoString("startupOptions"), new StructuredMemoString("daemon"), new StructuredMemoString("customServers"), new StructuredMemoString("contractAddress"), new StructuredMemoString("tags"), new UInt32("txFee"), new StructuredPrototypeType("dirNames")]), _defineProperty(_schemas, STRUCTURED_COIN_OBJECT_AVAILABLE_MODES_HASH, [new Boolean("native"), new Boolean("electrum"), new Boolean("eth")]), _defineProperty(_schemas, STRUCTURED_COIN_OBJECT_DIRECTORY_NAMES_HASH, [new StructuredMemoString("darwin"), new StructuredMemoString("linux"), new StructuredMemoString("win32")]), _schemas),
