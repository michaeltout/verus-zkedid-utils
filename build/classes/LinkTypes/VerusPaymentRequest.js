...
var VerusPaymentRequest = /*#__PURE__*/function () {
  ...
  _createClass(VerusPaymentRequest, null, [{
     ...
     */
    value: function create(currency_id, system_id, display_name, display_ticker, destination, amount) {
        ...
        data: _defineProperty({}, VERUS_PAYMENT_REQUEST, {
          ...
          data: _defineProperty({
            ...
            data: {
              ...
              currency_import_signature: sig_obj != null ? secure(sig_obj.signature) : '',
              currency_import_signer: sig_obj != null ? secure(sig_obj.signer) : '',
